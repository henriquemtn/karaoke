...
export default function Login() {
    ...
    const handleLogin = () => {
        ...
        return (
            <section className="bg-[#393939] text-white min-h-screen flex justify-center items-center">
                <div className="w-full lg:w-2/3 h-[600px] flex flex-row md:rounded-[15px] shadow-md">
